...
mod tests {
    ...
    const DESIGN_REQUEST_WIRE_BYTES: [u8; ORDER_REQUEST_WIRE_SIZE] = [
        0x01, 0x00, 0x00, 0x00, 0xEF, 0xBE, 0xAD, 0xDE, 0x00, 0x00, 0x01, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x33, 0x33, 0x33, 0x33, 0x03, 0xF3, 0xEF, 0x40,
        0x40, 0x42, 0x0F, 0x00, 0x00, 0x00, 0x00, 0x00, 0xEF, 0xCD, 0xAB, 0x89,
        0x67, 0x45, 0x23, 0x01, 0x00, 0x68, 0x92, 0x2B, 0x24, 0x13, 0x80, 0x18,
        0x76, 0x37, 0x5F, 0x6D, 0x61, 0x5F, 0x63, 0x72, 0x6F, 0x73, 0x73, 0x00,
    ...
    const DESIGN_RESULT_WIRE_BYTES: [u8; ORDER_RESULT_WIRE_SIZE] = [
        ,
    ];
    ...
    fn random_request_wire(rng: &mut StdRng) -> OrderRequestWire {
        OrderRequestWire {
            ...
            side: if rng.gen_bool(0.5) { SIDE_BUY } else { SIDE_SELL },
            order_type: rng.gen_range(ORDER_TYPE_LIMIT..=ORDER_TYPE_STOP_MARKET),
            symbol_id: rng.r#gen(),
            tif: rng.gen_range(TIF_GTC..=TIF_GTX),
            level: if rng.gen_bool(0.5) { LEVEL_OPEN } else { LEVEL_CLOSE },
            flags: if rng.gen_bool(0.5) { FLAG_REDUCE_ONLY } else { 0 },
            _pad0: 0,
            _pad1: 0,
    ...
    fn design_invariance_order_request_wire() {
        ...
        let decoded = OrderRequestWire::decode(&DESIGN_REQUEST_WIRE_BYTES)
            .expect("design request decode");
        assert_eq!(decoded, wire);
    }
