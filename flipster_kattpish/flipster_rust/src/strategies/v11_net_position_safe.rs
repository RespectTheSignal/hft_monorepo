...
pub struct V11NetPositionSafeStrategyCore {
...
impl V11NetPositionSafeStrategyCore {
...
impl StrategyCore for V11NetPositionSafeStrategyCore {
    fn name(&self) -> &str {
        "V11NetPositionSafeStrategy"
    }
    ...
    fn calculate_signal(
        ...
        signal_calculator::calculate_signal_v8(snapshot, &contract, gate_last_trade, market_state)
    ...
    fn handle_chance(
        ...
        crate::handle_chance::handle_chance_v11_total_net_position_safe(
            chance,
            gate_order_manager,
            trade_settings,
