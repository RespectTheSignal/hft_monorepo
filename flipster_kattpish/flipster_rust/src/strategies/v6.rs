...
impl StrategyCore for V6StrategyCore {
    fn name(&self) -> &str {
        "V6Strategy"
    }
    ...
    fn decide_order(
        ...
        // min(size_trigger * size_threshold_multiplier, max_size_trigger / 2)
        ...
        let order_tif = match level.as_str() {
            ...
            "market_open" => "ioc".to_string(),  // Market order usually implies IOC or FOK
            _ => "fok".to_string(),
        };
