// Extract Flipster cookies via Chrome DevTools Protocol on localhost:{port}.
// Mirrors Python flipster_latency_pick.py::_extract_cookies.
...
/// Returns [(name, value)] for cookies whose domain contains "flipster".
